    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_TAB,   KC_Z, KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_BSLS,
                       KC_VOLD, KC_VOLU,                                         KC_MPLY, KC_MNXT,
                                         ...
                                         KC_LCTL,KC_LSFT,       KC_DEL,  RIGHT
    ),

    [_LEFT] = LAYOUT(
         KC_F12,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,       _______,_______,_______,_______,_______,_______,
        _______,_______,_______,  KC_UP,_______, KC_F18,       _______,_______,_______,_______,_______,_______,
        KC_GRV, KC_PAUS,KC_LEFT,KC_DOWN,KC_RGHT,_______,       _______,_______,_______,_______,_______,_______,
        KC_SPC, KC_BRID,KC_BRIU,KC_CALC,KC_PSCR,IT_LABK,       _______,_______,_______,_______,_______,_______,
